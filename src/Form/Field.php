...
use LaravelCms\Form\Concerns\Makeable;
use LaravelCms\Form\Contracts\Fieldable;
use LaravelCms\Form\Exceptions\FieldRequiredAttributeException;
use Throwable;
...
{
    use Makeable, Conditionable, Macroable {
    ...
    {
        $this->typeForm = 'cms::partials.fields.vertical';
    ...
    {
        $this->typeForm = 'cms::partials.fields.clear';
    ...
    {
        $this->typeForm = 'cms::partials.fields.horizontal';
